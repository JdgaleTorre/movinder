...
var fillMovies = function () { return __awaiter(void 0, void 0, void 0, function () {
    var csvFilePath, headers, fileContent;
    return __generator(this, function (_a) {
        csvFilePath = path.resolve("./scripts/Movies.csv");
        headers = [
            "movieId",
            "title",
            "original_title",
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, db_1.db.movie.createMany({ data: result })];
                    case 1:
                        creation = _a.sent();
